 ...
 * @returns хеш
 */
exports.createHash = _afterPluginsLoaded_1._afterPluginsLoaded(function (unencryptedMessage, encoding) { return __awaiter(void 0, void 0, void 0, function () {
    var cadesplugin;
    return __generator(this, function (_a) {
        cadesplugin = window.cadesplugin;
    ...
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function decryptEnvelopedData() {
                ...
                try {
                    ...
                    console.error(error);
                    throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error) || 'Ошибка при расшифровании данных');
                }
