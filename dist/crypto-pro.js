...
/***/ "./api/getAttachedSignatureCertificates.ts":
/*!*************************************************!*\
  !*** ./api/getAttachedSignatureCertificates.ts ***!
  \*************************************************/
/*! no static exports found */
 ...
 */
exports.getAttachedSignatureCertificates = _afterPluginsLoaded_1._afterPluginsLoaded(function (signedMessage, unencryptedMessage) {
    var cadesplugin = window.cadesplugin;
    return eval(_generateCadesFn_1._generateCadesFn(function verifyAttachedSignature() {
        var cadesSignedData;
        try {
            cadesSignedData = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.CadesSignedData');
        }
        ...
        try {
            void (_generateCadesFn_1.__cadesAsyncToken__ + cadesSignedData.VerifyCades(signedMessage, cadesplugin.CADESCOM_PKCS7_TYPE, true));
            cadesCertificates = _generateCadesFn_1.__cadesAsyncToken__ + cadesSignedData.Certificates;
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./getAttachedSignatureCertificates */ "./api/getAttachedSignatureCertificates.ts"));
...
__export(__webpack_require__(/*! ./verifyAttachedSignature */ "./api/verifyAttachedSignature.ts"));
...
/***/ "./api/verifyAttachedSignature.ts":
/*!****************************************!*\
  !*** ./api/verifyAttachedSignature.ts ***!
  \****************************************/
/*! no static exports found */
 ...
 * @returns boolean
 */
exports.verifyAttachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (signedMessage, unencryptedMessage) { return __awaiter(void 0, void 0, void 0, function () {
    var cadesplugin;
    return __generator(this, function (_a) {
        cadesplugin = window.cadesplugin;
        return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function verifyAttachedSignature() {
                var cadesSignedData;
                try {
                    cadesSignedData = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.CadesSignedData');
                }
                ...
                try {
                    isValid =
                        _generateCadesFn_1.__cadesAsyncToken__ + cadesSignedData.VerifyCades(signedMessage, cadesplugin.CADESCOM_PKCS7_TYPE, true);
                }
                catch (error) {
                    console.error(error);
                    throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error) || 'Ошибка при валидации подписи');
                }
                return isValid;
            }))];
    });
