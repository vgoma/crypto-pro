...
/***/ "./api/createSignatureCadesXML.ts":
/*!****************************************!*\
  !*** ./api/createSignatureCadesXML.ts ***!
  \****************************************/
/*! no static exports found */
...
exports.createSignatureCadesXML = _afterPluginsLoaded_1._afterPluginsLoaded(function (thumbprint, xml, st) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                Certificate = _a.sent();
                return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function createSignatureCadesXML() {
                        var cadesSignedXML;
                        var cadesSigner;
                        var signMethod;
                        var digestMethod;
                        ...
                        var pk = _generateCadesFn_1.__cadesAsyncToken__ + Certificate.PublicKey();
                        var Algorithm = _generateCadesFn_1.__cadesAsyncToken__ + pk.Algorithm;
                        var algoOid = _generateCadesFn_1.__cadesAsyncToken__ + Algorithm.Value;
...
__export(__webpack_require__(/*! ./createSignatureCadesXML */ "./api/createSignatureCadesXML.ts"));
__export(__webpack_require__(/*! ./verifyXML */ "./api/verifyXML.ts"));
 ...
 * @returns подписанный XML
 */
exports.verifyXML = _afterPluginsLoaded_1._afterPluginsLoaded(function (signedxml) { return __awaiter(void 0, void 0, void 0, function () {
    var cadesplugin;
    return __generator(this, function (_a) {
        cadesplugin = window.cadesplugin;
        return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function verifyXML() {
                var cadesSignedXML;
                try {
                    cadesSignedXML = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.SignedXML');
                }
                ...
                try {
                    void (_generateCadesFn_1.__cadesAsyncToken__ + cadesSignedXML.Verify(signedxml));
                    return true;
                }
                catch (error) {
                    return false;
