 ...
 */
exports.createAttachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, dt = new Date()) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return eval(_generateCadesFn_1._generateCadesFn(function createAttachedSignature() {
        ...
        const currentTime = _getDateObj_1._getDateObj(dt !== null && dt !== void 0 ? dt : new Date());
        try {
 ...
 * @returns подпись в формате PKCS#7
 */
exports.createDetachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, messageHash, dt = new Date()) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
