 ...
 * @returns подпись в формате PKCS#7
 */
exports.addDetachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, signedMessage, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
 ...
 */
exports.setLogLevel = _afterPluginsLoaded_1._afterPluginsLoaded((level) => {
