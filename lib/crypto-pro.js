 ...
 */
exports.getAttachedSignatureCertificates = _afterPluginsLoaded_1._afterPluginsLoaded((signedMessage, unencryptedMessage) => {
    const { cadesplugin } = window;
 ...
 * @returns boolean
 */
exports.verifyAttachedSignature = _afterPluginsLoaded_1._afterPluginsLoaded((signedMessage, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    return eval(_generateCadesFn_1._generateCadesFn(function verifyAttachedSignature() {
        let cadesSignedData;
        try {
